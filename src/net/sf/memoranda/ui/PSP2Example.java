...
public class PSP2Example extends JPanel {
	...
	//Initializing the example text field
	JTextField example = new JTextField(20);
	...
	void jbInit() throws Exception {
		...
		//Example
		String exampleText = 	"This is an example for PSP2. " +
								"In this example, text will be given depicting the work done by a student on a small project. " +
								"The filled out text fields on the left are an example of what the developer would enter in their Time Recording sheet.\n\n" +
								"On 1/10/16, they worked from 10:30 AM to 4:45 PM on planning. They were able to finish the planning.\n" +
								"On 1/12/16, they worked from 9:00 AM to 4:30 PM on the design.\n" +
								"On 1/13/16, they worked from 9:30 AM to 4:30 PM. They finished the design and started on the code.\n" +
								"On 1/15/16, they worked from 10:00 AM to 5:00 PM on the code.\n" +
								"On 1/19/16, they worked from 12:00 PM to 3:00 PM on the code. They were able to finish the code.\n" +
								"On 1/25/16, they worked from 1:00 PM to 4:00 PM reviewing the code. They were able to finish the review.\n" +
								"On 2/2/16, they worked from 9:00 AM to 3:00 PM on testing. They were able to finish testing.\n" +
								"On 2/6/16, they worked from 12:00 PM to 4:00 PM on the postmortem. They were able to finish the postmortem.\n\n" +
								"For more information about PSP Time Recording, visit http://www.sei.cmu.edu/reports/00tr022.pdf";
				
				
		JTextArea exampleArea = new JTextArea(exampleText, 5, 20);
		exampleArea.setLineWrap(true);
		exampleArea.setWrapStyleWord(true);
		exampleArea.setBounds(400 + insets.left + date1Size.width + start1Size.width + stop1Size.width + phase1Size.width, 40 + titleSize.height + commentsSize.height + insets.top, 500, 400);
		
		//Adding text to the textfields
		comments1.setText("Finished planning");
		comments3.setText("Finished design");
		comments5.setText("Finished code");
		comments6.setText("Finished review");
		comments7.setText("Finished testing");
		comments8.setText("Finished postmortem");
		
		phase1.setText("Planning");
		phase2.setText("Design");
		phase3.setText("Design/Code");
		phase4.setText("Code");
		phase5.setText("Code");
		phase6.setText("Code Review");
		phase7.setText("Testing");
		phase8.setText("Postmortem");
		
		
		stop1.setText("4:45 PM");
		stop2.setText("4:30 PM");
		stop3.setText("4:30 PM");
		stop4.setText("5:00 PM");
		stop5.setText("3:00 PM");
		stop6.setText("4:00 PM");
		stop7.setText("3:00 PM");
		stop8.setText("4:00 PM");
		
		
		start1.setText("10:30 AM");
		start2.setText("9:00 AM");
		start3.setText("9:30 AM");
		start4.setText("10:00 AM");
		start5.setText("12:00 PM");
		start6.setText("1:00 PM");
		start7.setText("9:00 AM");
		start8.setText("12:00 PM");
		
		
		
		date1.setText("1/10/16");
		date2.setText("1/12/16");
		date3.setText("1/13/16");
		date4.setText("1/15/16");
		date5.setText("1/19/16");
		date6.setText("1/25/16");
		date7.setText("2/2/16");
		date8.setText("2/6/16");
