/**
 * Mailing.java
 * Created on 2.6.2015, 0:31:22 Travis
 * Package: net.sf.memoranda.util
 *
 * @author Travis Dudzinski
 */
package net.sf.memoranda.util;
...
public class Mailing {
	...
	public static Properties loadProperties() throws Exception {
		...
		//prop.load(new FileInputStream(Configuration.getConfigPath())); //Kludge
		return prop;
	}
	...
	public static void mailScheduler() throws Exception {
